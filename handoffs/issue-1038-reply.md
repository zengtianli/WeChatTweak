...
> 已贴上游的是【简单版】：https://github.com/sunnyyoung/WeChatTweak/issues/1038#issuecomment-5513176192 （2026-09-02）。
> 之前贴的完整版评论 5513041305 在 GitHub 侧已不存在（API 404，原因不明，疑被自动过滤），故重贴为简单版。【完整版】留档，有人追问细节时贴。
> 修复 commit `4178aab`。
